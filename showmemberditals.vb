...
Public Class showmemberditals
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vishal.showmemberditals.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedshowmemberditals
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As showmemberditals = New showmemberditals()
        rpt.Site = Me.Site
        Return rpt
    End Function
