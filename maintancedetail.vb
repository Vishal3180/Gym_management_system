...
Public Class maintancedetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vishal.maintancedetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmaintancedetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As maintancedetail = New maintancedetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
